...
namespace Game.Entities
{
    public class ObstacleUnscaled : DestroyableEntity, IDirectable
    {
        ...
        protected override void Awake()
        {
            ...
            trailParticles.startColor = new Color(_renderer.color.r, _renderer.color.g, _renderer.color.b, 0.25f); // C�digo obsoleto pero que me da pereza buscar hacerlo bien :)
